...
def get_pie_chart(entered_site):
    ...
    data = filtered_df.groupby('Launch Site')['class'].count().reset_index(name='Count')
    data['Success Rate'] = data['Count'] / len(filtered_df)
    if entered_site == 'ALL':
        ...
        fig = px.pie(values=[success_rate, 1-success_rate], 
